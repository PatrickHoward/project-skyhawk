...
mod crc32 {
    const CRC32TBL: [u32; 256] = [
        ...
        0xC0BA6CAD, 0xEDB88320, 0x9ABFB3B6, 0x03B6E20C, 0x74B1D29A, 0xEAD54739, 0x9DD277AF,
        0x04DB2615, 0x73DC1683, 0xE3630B12, 0x94643B84, 0x0D6D6A3E, 0x7A6A5AA8, 0xE40ECF0B,
        0x9309FF9D, 0x0A00AE27, 0x7D079EB1, 0xF00F9344, 0x8708A3D2, 0x1E01F268, 0x6906C2FE,
        ...
        0x92D28E9B, 0xE5D5BE0D, 0x7CDCEFB7, 0x0BDBDF21, 0x86D3D2D4, 0xF1D4E242, 0x68DDB3F8,
    ...
    pub fn hash(value: &str) -> u32 {
        ...
        for value in value.chars() {
            let ind = ((crc ^ ((value.to_ascii_lowercase() as u32) << 24)) >> 24) as usize;
            crc = (crc << 8) ^ CRC32TBL[ind % CRC32TBL.len()];
        }
...
impl StrId {
    pub fn new(value: &str) -> Self {
        let key = crc32::hash(value);
        StrId { key }
    }
}

pub trait AsStrId {
    fn as_str_id(&self) -> StrId;
}

impl AsStrId for &str {
    fn as_str_id(&self) -> StrId {
        StrId::new(self)
    }
}

impl AsStrId for String {
    fn as_str_id(&self) -> StrId {
